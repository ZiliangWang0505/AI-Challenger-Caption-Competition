    ...
    with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
        ...
        with tf.variable_scope(scope, 'BlockReductionA', [inputs], reuse=reuse):
            with tf.variable_scope('Branch_0'):
                branch_0 = slim.conv2d(
                    inputs, 384, [
                        3, 3], stride=2, padding='VALID', scope='Conv2d_1a_3x3')
            with tf.variable_scope('Branch_1'):
                branch_1 = slim.conv2d(
                    inputs, 192, [
                        1, 1], scope='Conv2d_0a_1x1')
    ...
    with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
        ...
        with tf.variable_scope(scope, 'BlockInceptionB', [inputs], reuse=reuse):
            ...
            with tf.variable_scope('Branch_1'):
                ...
                branch_1 = slim.conv2d(
                    branch_1, 224, [
                        1, 7], scope='Conv2d_0b_1x7')
                branch_1 = slim.conv2d(
                    branch_1, 256, [
                        7, 1], scope='Conv2d_0c_7x1')
            with tf.variable_scope('Branch_2'):
                branch_2 = slim.conv2d(
                    inputs, 192, [
                        1, 1], scope='Conv2d_0a_1x1')
                branch_2 = slim.conv2d(
                    branch_2, 192, [
                        7, 1], scope='Conv2d_0b_7x1')
                branch_2 = slim.conv2d(
                    branch_2, 224, [
                        1, 7], scope='Conv2d_0c_1x7')
                branch_2 = slim.conv2d(
                    branch_2, 224, [
                        7, 1], scope='Conv2d_0d_7x1')
                branch_2 = slim.conv2d(
                    branch_2, 256, [
                        1, 7], scope='Conv2d_0e_1x7')
            with tf.variable_scope('Branch_3'):
                branch_3 = slim.avg_pool2d(
                    inputs, [3, 3], scope='AvgPool_0a_3x3')
                branch_3 = slim.conv2d(
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            with tf.variable_scope('Mixed_3a'):
                ...
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(
                        net, 96, [
                            3, 3], stride=2, padding='VALID', scope='Conv2d_0a_3x3')
            ...
            with tf.variable_scope('Mixed_4a'):
                with tf.variable_scope('Branch_0'):
                    ...
                    branch_0 = slim.conv2d(
                        branch_0, 96, [
                            3, 3], padding='VALID', scope='Conv2d_1a_3x3')
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(
                        net, 64, [1, 1], scope='Conv2d_0a_1x1')
                    branch_1 = slim.conv2d(
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                if create_aux_logits:
                    with tf.variable_scope('AuxLogits'):
                        ...
                        aux_logits = slim.conv2d(
                            aux_logits, 768, aux_logits.get_shape()[
                                1:3], padding='VALID', scope='Conv2d_2a')
                ...
                with tf.variable_scope('Logits'):
                    ...
                    net = slim.avg_pool2d(
                        net, net.get_shape()[
                            1:3], padding='VALID', scope='AvgPool_1a')
                    # 1 x 1 x 1536
                    net = slim.dropout(
