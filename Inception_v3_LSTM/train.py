...
tf.flags.DEFINE_string(
    ...
    "/cephfs/group/youtu/gaia/atticuswang/AIChallenger/model_init_para/inception_v3/inception_v3.ckpt",
...
tf.flags.DEFINE_integer("number_of_steps", 4000000, "Number of training steps.")
